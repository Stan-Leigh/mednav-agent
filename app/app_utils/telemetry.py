...
def setup_telemetry() -> str | None:
    ...
    if bucket and capture_content != "false":
        ...
        os.environ.setdefault(
            ...
            f"service.namespace=mednav-agent,service.version={commit_sha}",
        )
...
def setup_agent_engine_telemetry() -> None:
    ...
    try:
        ...
        logging.warning(
            f"Could not load Google Cloud Application Default Credentials, skipping Agent Engine telemetry setup: {e}"
        )
